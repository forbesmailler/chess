...
static constexpr int MAX_THINK_MS = 60000;
static constexpr int TIME_ALLOCATION_DIVISOR = 50;
static constexpr int MOVE_OVERHEAD_MS = 200;
static constexpr int MIN_TIME_RESERVE_MS = 500;
...
static constexpr int MOVE_RETRY_DELAY_MS = 100;
